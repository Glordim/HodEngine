set(HOD_PLATFORM_SUBDIR "platforms/${HOD_PLATFORM_NAME}/${HOD_ABI_NAME}")

if(BUILD_SHARED_LIBS)
	set(HOD_LIB_TYPE_SUBDIR "shared")
else()
	set(HOD_LIB_TYPE_SUBDIR "static")
endif()

set(HOD_BIN_DIR "${CMAKE_BINARY_DIR}/Output/${HOD_PLATFORM_SUBDIR}/${HOD_LIB_TYPE_SUBDIR}/bin")
set(HOD_LIB_DIR "${CMAKE_BINARY_DIR}/Output/${HOD_PLATFORM_SUBDIR}/${HOD_LIB_TYPE_SUBDIR}/lib")
...
macro(hod_install_lib TARGET_NAME)
	install(TARGETS ${TARGET_NAME}
		...
		LIBRARY DESTINATION "${HOD_PLATFORM_SUBDIR}/${HOD_LIB_TYPE_SUBDIR}/lib"
		ARCHIVE DESTINATION "${HOD_PLATFORM_SUBDIR}/${HOD_LIB_TYPE_SUBDIR}/lib"
		RUNTIME DESTINATION "${HOD_PLATFORM_SUBDIR}/${HOD_LIB_TYPE_SUBDIR}/bin"
	)
...
macro(hod_target_natvis target)
	if(WIN32)
		file(GLOB_RECURSE _natvis_files "${CMAKE_CURRENT_SOURCE_DIR}/*.natvis")
		foreach(_natvis ${_natvis_files})
