...
if(NOT SET_UP_CONFIGURATIONS_DONE)
	...
	set(CMAKE_CXX_FLAGS_GAME_DEBUG "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}")
	set(CMAKE_EXE_LINKER_FLAGS_GAME_DEBUG "")

	set(COMPILE_DEFINITIONS_GAME_RELEASE
		HOD_GAME
		HOD_RELEASE
	)
	set(CMAKE_CXX_FLAGS_GAME_RELEASE "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_RELEASE}")
	set(CMAKE_EXE_LINKER_FLAGS_GAME_RELEASE "")

	set(COMPILE_DEFINITIONS_EDITOR_DEBUG
		HOD_EDITOR
		HOD_DEBUG
	)
	set(CMAKE_CXX_FLAGS_EDITOR_DEBUG "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}")
	...
	set(CMAKE_CXX_FLAGS_EDITOR_RELEASE "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_RELEASE}")
	...
	set(CMAKE_CXX_FLAGS_SERVER_DEBUG "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}")
	set(CMAKE_EXE_LINKER_FLAGS_SERVER_DEBUG "")

	set(COMPILE_DEFINITIONS_SERVER_RELEASE
		HOD_SERVER
		HOD_RELEASE
	)
	set(CMAKE_CXX_FLAGS_SERVER_RELEASE "${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_RELEASE}")
	set(CMAKE_EXE_LINKER_FLAGS_SERVER_RELEASE "")
endif()
