...
function(add_compile_definitions_for_configs target)
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Game_Debug>:${COMPILE_DEFINITIONS_GAME_DEBUG}>")
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Game_Release>:${COMPILE_DEFINITIONS_GAME_RELEASE}>")
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Editor_Debug>:${COMPILE_DEFINITIONS_EDITOR_DEBUG}>")
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Editor_Release>:${COMPILE_DEFINITIONS_EDITOR_RELEASE}>")
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Server_Debug>:${COMPILE_DEFINITIONS_SERVER_DEBUG}>")
	target_compile_definitions(${target} PRIVATE "$<$<CONFIG:Server_Release>:${COMPILE_DEFINITIONS_SERVER_RELEASE}>")
endfunction()
...
if(NOT SET_UP_CONFIGURATIONS_DONE)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_GAME_RELEASE ${CMAKE_SHARED_LINKER_FLAGS_RELEASE})

	set(COMPILE_DEFINITIONS_EDITOR_DEBUG
		HOD_EDITOR
		HOD_DEBUG
		HOD_CONFIG=Editor_Debug
	)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_EDITOR_DEBUG ${CMAKE_SHARED_LINKER_FLAGS_DEBUG})

	set(COMPILE_DEFINITIONS_EDITOR_RELEASE
		HOD_EDITOR
		HOD_RELEASE
		HOD_CONFIG=Editor_Release
	)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_EDITOR_RELEASE ${CMAKE_SHARED_LINKER_FLAGS_RELEASE})

	set(COMPILE_DEFINITIONS_SERVER_DEBUG
		HOD_SERVER
		HOD_DEBUG
		HOD_CONFIG=Server_Debug
	)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_SERVER_DEBUG ${CMAKE_SHARED_LINKER_FLAGS_DEBUG})

	set(COMPILE_DEFINITIONS_SERVER_RELEASE
		HOD_SERVER
		HOD_RELEASE
		HOD_CONFIG=Server_Release
	)
	...
	set(CMAKE_SHARED_LINKER_FLAGS_SERVER_RELEASE ${CMAKE_SHARED_LINKER_FLAGS_RELEASE})
endif()
