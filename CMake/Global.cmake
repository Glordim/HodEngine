...
function(SetupCompilation)
	...
	set(CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g")
	set(CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -g")
	if (MSVC)
	...
	if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
		set(CXX_FLAGS "${CXX_FLAGS} -Wall -Wextra -Wpedantic -Wno-invalid-offsetof -Wno-nullability-completeness -Werror -D_CRT_SECURE_NO_WARNINGS -D_ITERATOR_DEBUG_LEVEL=0")
		if(MSVC)
