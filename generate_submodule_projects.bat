...
if "%PM_cmake_PATH%" == "" (    
    set PM_CMAKE=cmake.exe
) else (
    set PM_CMAKE="%PM_cmake_PATH%\cmake.exe"
)
...
-DATB_EVENT_HANDLER_WINDOWS:BOOL=OFF ^
-DATB_EVENT_HANDLER_X11:BOOL=OFF ^
-DATB_EVENT_HANDLER_GLFW:BOOL=OFF ^
-DATB_EVENT_HANDLER_GLFW3:BOOL=ON ^
-DATB_EVENT_HANDLER_GLUT:BOOL=OFF ^
-DATB_EVENT_HANDLER_SDL12:BOOL=OFF ^
-DATB_EVENT_HANDLER_SDL13:BOOL=OFF ^
-DATB_EVENT_HANDLER_SDL20:BOOL=OFF ^
-DATB_EVENT_HANDLER_SFML:BOOL=OFF ^
-DATB_GUIRENDERER_USE_CORE_GL:BOOL=ON ^
-DATB_GUIRENDERER_USE_D3D10:BOOL=OFF ^
-DATB_GUIRENDERER_USE_D3D11:BOOL=OFF ^
-DATB_GUIRENDERER_USE_D3D9:BOOL=OFF ^
-DATB_GUIRENDERER_USE_LEGACY_GL:BOOL=OFF
