...
namespace HOD
{
	namespace RENDERER
	{
		...
		bool RendererVulkan::BuildPipeline(GpuDevice* physicalDevice)
		{
			...
			Shader* vertexShader = CreateShader("Shader/UnlitVertexColor.vert.spirv", Shader::Vertex);
			if (vertexShader == nullptr)
			{
				return false;
			}

			Shader* fragmentShader = CreateShader("Shader/UnlitVertexColor.frag.spirv", Shader::Fragment);
