...
namespace HOD
{
	namespace RENDERER
	{
		_SingletonInstance(RendererVulkan)
		...
		*/
		...
		bool RendererVulkan::Init(Window* mainWindow, uint32_t physicalDeviceIdentifier)
		{
			...
			mainWindow->SetContext(_context);
			return true;
		}
		...
		/// @param window 
		/// @return 
		VkSurfaceKHR RendererVulkan::CreateSurface(Window* window)
		{
		...
		/// @param window 
		/// @return 
		bool RendererVulkan::CreateContext(Window* window)
		{
			...
			window->SetContext(new VkContext(surface));
			return true;
		}
