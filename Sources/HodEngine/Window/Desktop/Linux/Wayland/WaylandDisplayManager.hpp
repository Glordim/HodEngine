...
namespace hod::window
{
    ...
    class HOD_API WaylandDisplayManager : public DesktopDisplayManager
    {
    ...
    private:
        ...
        private:
            ...
            static void    OutputGeometry(void* userData, wl_output* wl_output, int32_t x, int32_t y, int32_t physicalWidth, int32_t physicalHeight, int32_t subpixel, const char* make, const char* model, int32_t transform);
