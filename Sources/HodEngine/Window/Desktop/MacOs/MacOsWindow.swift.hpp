...
#ifndef HOD_SWIFT_SWIFT_H
#define HOD_SWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hod_swift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("hod_swift", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace hod_swift SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("hod_swift") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void * _Nonnull $s9hod_swift17MacOsNativeWindowCACycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN void $s9hod_swift17MacOsNativeWindowC4ShowyyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // Show()
SWIFT_EXTERN void $s9hod_swift17MacOsNativeWindowC8MaximizeyyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // Maximize()
SWIFT_EXTERN void $s9hod_swift17MacOsNativeWindowC6CenteryyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // Center()
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_hod_swift_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_hod_swift_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_hod_swift_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_hod_swift_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void $s9hod_swift19printWelcomeMessageyySSF(struct swift_interop_passStub_hod_swift_uint64_t_0_8_void_ptr_8_16 name) SWIFT_NOEXCEPT SWIFT_CALL; // printWelcomeMessage(_:)
...
class SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowC") MacOsNativeWindow;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<hod_swift::MacOsNativeWindow> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_MacOsNativeWindow;
// Type metadata accessor for MacOsNativeWindow
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s9hod_swift17MacOsNativeWindowCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowC") MacOsNativeWindow : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK MacOsNativeWindow init() SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowCACycfc");
  SWIFT_INLINE_THUNK void Show() SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowC4ShowyyF");
  SWIFT_INLINE_THUNK void Maximize() SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowC8MaximizeyyF");
  SWIFT_INLINE_THUNK void Center() SWIFT_SYMBOL("s:9hod_swift17MacOsNativeWindowC6CenteryyF");
protected:
  SWIFT_INLINE_THUNK MacOsNativeWindow(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_MacOsNativeWindow;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s9hod_swift17MacOsNativeWindowCD;
  static inline constexpr $s9hod_swift17MacOsNativeWindowCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_MacOsNativeWindow {
public:
static SWIFT_INLINE_THUNK MacOsNativeWindow makeRetained(void * _Nonnull ptr) noexcept { return MacOsNativeWindow(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<hod_swift::MacOsNativeWindow> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return hod_swift::_impl::$s9hod_swift17MacOsNativeWindowCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<hod_swift::MacOsNativeWindow> { using type = hod_swift::_impl::_impl_MacOsNativeWindow; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_INLINE_THUNK void printWelcomeMessage(const swift::String& name) noexcept SWIFT_SYMBOL("s:9hod_swift19printWelcomeMessageyySSF") {
  return _impl::$s9hod_swift19printWelcomeMessageyySSF(_impl::swift_interop_passDirect_hod_swift_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(name)));
}

  SWIFT_INLINE_THUNK MacOsNativeWindow MacOsNativeWindow::init() {
  return _impl::_impl_MacOsNativeWindow::makeRetained(_impl::$s9hod_swift17MacOsNativeWindowCACycfC(swift::TypeMetadataTrait<MacOsNativeWindow>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK void MacOsNativeWindow::Show() {
...
#endif
struct FTypeAddress {
decltype(_impl::$s9hod_swift17MacOsNativeWindowC4ShowyyF) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 96 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK void MacOsNativeWindow::Maximize() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s9hod_swift17MacOsNativeWindowC8MaximizeyyF) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 104 / sizeof(void *));
  return (* fptrptr_->func)(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void MacOsNativeWindow::Center() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s9hod_swift17MacOsNativeWindowC6CenteryyF) * func;
};
