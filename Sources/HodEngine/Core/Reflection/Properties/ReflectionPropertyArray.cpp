...
namespace hod
{
	...
	/// @param offset 
	/// @param name 
	ReflectionPropertyArray::ReflectionPropertyArray(Adapter adapter, ReflectionPropertyVariable::Type type, uint32_t offset, const char* name, ReflectionDescriptor* elementReflectionDescriptor)
