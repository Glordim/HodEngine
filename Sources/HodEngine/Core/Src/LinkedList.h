...
namespace hod
{
	...
	public:
		...
		LinkedList<Type>::Iterator	begin() { return Iterator(this); }
		LinkedList<Type>::Iterator	end() { return Iterator(nullptr); }

		LinkedList<Type>::Iterator	begin() const { return Iterator((LinkedList<Type>*)(this)); }
		LinkedList<Type>::Iterator	end() const { return Iterator(nullptr); }

		const LinkedList<Type>::Iterator	cbegin() const { return Iterator(this); }
		const LinkedList<Type>::Iterator	cend() const { return Iterator(nullptr); }
