...
namespace hod
{
	...
	bool ImageTextButton(ImTextureID image, ImVec2 imageSize, const char* label, ImVec2 size_arg = ImVec2(0.0f, 0.0f), ImGuiButtonFlags flags = 0, ImDrawFlags drawFlags = ImDrawFlags_RoundCornersAll);
}
