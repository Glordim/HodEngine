...
namespace hod::editor
{
	...
	/// @param operation 
	/// @return 
	bool ComponentCustomEditor::OnDrawGizmo(std::shared_ptr<game::Component> component, const Matrix4& projection, const Matrix4& view, ImGuizmo::OPERATION operation)
	{
		return false;
	}
}
